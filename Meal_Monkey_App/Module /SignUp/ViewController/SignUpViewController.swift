...
class SignUpViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        EditStyle.setborder(
            textfields: [txtName, txtEmail, txtMobile, txtAddress, txtName, btnSignUp],
            cornerRadious: 28
        )

        // Add padding inside text fields
        EditStyle.setPadding(
            textFields: [txtName, txtEmail, txtMobile, txtAddress, txtPassword, txtConfirmPassword],
            paddingWidth: 34
        )
    ...
    @IBAction func btnSignUpclick(_ sender: Any) {
        ...
        if name.isEmpty && email.isEmpty && mobile.isEmpty && address.isEmpty &&
            ...
            UIAlertController.showAlert(title: "Missing Info",
        ...
        if name.isEmpty {
            UIAlertController.showAlert(title: "Name Missing",
        ...
        if mobile.isEmpty {
            UIAlertController.showAlert(title: "Mobile Number Missing",
        ...
        if address.isEmpty {
            UIAlertController.showAlert(title: "Address Missing",
        ...
        if password.isEmpty {
            UIAlertController.showAlert(title: "Password Missing",
        ...
        if password != confirmPassword {
            UIAlertController.showAlert(title: "Passwords Don't Match",
        ...
        do {
            ...
            if !existingUsers.isEmpty {
                UIAlertController.showAlert(title: "Email Exists",
